...
JQ := $(shell which jq)
HTTPS_GIT := https://github.com/gnzat/feather.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=$(FEATH_CONFIG_APP_NAME) \
		  ...
		  -X github.com/gnzat/feather/app.AppName=$(FEATH_CONFIG_APP_NAME) \
		  -X github.com/gnzat/feather/app.AccountAddressPrefix=$(FEATH_CONFIG_ACC_ADDR_PREFIX) \
		  -X github.com/gnzat/feather/app.AccountPubKeyPrefix=$(FEATH_CONFIG_ACC_PUBKEY_PREFIX) \
		  -X github.com/gnzat/feather/app.ValidatorAddressPrefix=$(FEATH_CONFIG_VALIDATOR_ADDRESS_PREFIX) \
		  -X github.com/gnzat/feather/app.ValidatorPubKeyPrefix=$(FEATH_CONFIG_VALIDATOR_PUBKEY_PREFIX) \
		  -X github.com/gnzat/feather/app.ConsensusNodeAddressPrefix=$(FEATH_CONFIG_CONS_NODE_ADDR_PREFIX) \
		  -X github.com/gnzat/feather/app.ConsensusNodePubKeyPrefix=$(FEATH_CONFIG_ACC_PUBKEY_PREFIX) \
		  -X github.com/gnzat/feather/app.BondDenom=$(FEATH_CONFIG_BOND_DENOM)
